...
# Install Python dependencies for ScalabilityTuningRF.py
RUN pip3 install --no-cache-dir Cython nose numpy scikit-learn
...
RUN set -x \
    ...
    && rm -rf slurm \
    && yum clean all \
    && rm -rf /var/cache/yum /root/.cache /usr/share/doc /usr/share/man /usr/share/info /tmp/*
